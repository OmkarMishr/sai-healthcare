      ...
      <div className="mx-auto max-w-6xl px-4 py-16 md:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.3fr]">
          <div>
            ...
            <p className="mt-4 flex items-start gap-2 rounded-xl bg-cream-50 px-4 py-3 text-sm text-plum-900/60">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {c.points.map((p) => (
              <div key={p.title} className="rounded-2xl border border-plum-100 bg-cream-50 p-6">
                <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-white text-coral-600 shadow-sm">
