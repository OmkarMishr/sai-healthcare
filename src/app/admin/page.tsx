...
export default function DashboardPage() {
  ...
  const cards = [
    { label: "Total Patients", value: stats?.patients, icon: "🧑‍🤝‍🧑", href: "/admin/patients" },
    { label: "Today's Appointments", value: stats?.today, icon: "📅", href: "/admin/appointments" },
    { label: "Pending Requests", value: stats?.pending, icon: "⏳", href: "/admin/appointments?status=pending" },
    { label: "Upcoming", value: stats?.upcoming, icon: "🔜", href: "/admin/appointments" },
    { label: "Active Doctors", value: stats?.doctors, icon: "👨‍⚕️", href: "/admin/doctors" },
  ];
  ...
  return (
    <AdminShell title="Dashboard">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        ...
        >
          <p className="font-display text-lg font-bold">＋ Add / Manage Patients</p>
        ...
        >
          <p className="font-display text-lg font-bold">📅 Appointments by Date</p>
